...
\renewcommand{\CancelColor}{\color{glaucous}}

\makeatletter
\newcommand{\mybox}[1]{%
  \setbox0=\hbox{#1}%
  \setlength{\@tempdima}{\dimexpr\wd0+13pt}%
  \begin{tcolorbox}[colback=glaucous,colframe=glaucous,boxrule=0.5pt,arc=4pt,
...
\usecolortheme[named=glaucous]{structure}
...
\colorlet{purpleTitleBlockColor}{ceil}
\colorlet{purpleBlockColor}{glaucous!15!gray}
