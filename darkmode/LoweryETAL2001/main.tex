...
\title[\cite{lowery2001social}]{Social Influence Effects}
\subtitle{\large on Automatic Racial Prejudice}
\author{Brian S. Lowery, Curtis D. Hardin and Stacey Sinclair}
...
\setbeamertemplate{footline}
    ...
    \input{chapters/2_experiments.tex}
    
    \input{chapters/3_discuss.tex}
