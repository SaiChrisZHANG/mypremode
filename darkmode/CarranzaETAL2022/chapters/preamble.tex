...
\definecolor{mygreen}{rgb}{0.5, 0.66, 0.42}
...
\definecolor{lightlavender}{rgb}{0.75, 0.58, 0.89}
...
\definecolor{paleredviolet}{rgb}{0.86, 0.44, 0.58}
\definecolor{pistachio}{rgb}{0.58, 0.77, 0.45}
\definecolor{shamrockgreen}{rgb}{0.0, 0.62, 0.38}
\definecolor{sinopia}{rgb}{0.8, 0.25, 0.04}

\renewcommand{\CancelColor}{\color{darklavender}}

\makeatletter
\newcommand{\mybox}[1]{%
  \setbox0=\hbox{#1}%
  \setlength{\@tempdima}{\dimexpr\wd0+13pt}%
  \begin{tcolorbox}[colback=sinopia,colframe=sinopia,boxrule=0.5pt,arc=4pt,
...
\usecolortheme[named=fuzzywuzzy]{structure}
...
\newcommand{\texthlit}[1]{
  \textcolor{fuzzywuzzy!65!white}{\underline{\textit{#1}}}
}

\newcommand{\texthlbf}[1]{
  \textcolor{fuzzywuzzy!65!white}{\underline{\textbf{#1}}}
}

\newcommand{\boxsinopia}[1]{
\begin{center}
\fcolorbox{glaucous}{gray!80!black}{
\begin{minipage}{0.95\textwidth}
#1
\end{minipage}
}
...
% Block colors
\colorlet{TitleBlockColor}{fuzzywuzzy!75!white}
\colorlet{BlockColor}{fuzzywuzzy!2!gray}
...
\AtBeginEnvironment{block}{%
  \setbeamercolor{itemize item}{fg=TitleBlockColor!70}}
