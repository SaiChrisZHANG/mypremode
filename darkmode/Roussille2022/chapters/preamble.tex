...
\newcommand{\mybox}[1]{%
  ...
  \begin{tcolorbox}[colback=babyblue,colframe=babyblue,boxrule=0.5pt,arc=4pt,
...
\usecolortheme[named=frenchlilac]{structure}
...
\begin{center}
\fcolorbox{frenchlilac}{gray!80!black}{
\begin{minipage}{0.95\textwidth}
#1
\end{minipage}
}
...
% Block colors
\colorlet{TitleBlockColor}{frenchlilac!45!white}
\colorlet{BlockColor}{frenchlilac!25!gray}
