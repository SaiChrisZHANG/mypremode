...
\newcommand{\mybox}[1]{%
  ...
  \begin{tcolorbox}[colback=darklavender,colframe=darklavender,boxrule=0.5pt,arc=4pt,
...
\usecolortheme[named=darklavender]{structure}
...
\newcommand{\boxlavender}[1]{
\begin{center}
\fcolorbox{darklavender}{gray!80!black}{
\begin{minipage}{0.95\textwidth}
#1
\end{minipage}
}
...
\colorlet{greenBlockColor}{mygreen!25!gray}
\colorlet{purpleTitleBlockColor}{lightlavender}
\colorlet{purpleBlockColor}{darklavender!25!gray}
...
\AtBeginEnvironment{block}{%
  \setbeamercolor{itemize item}{fg=purpleTitleBlockColor!70}}
