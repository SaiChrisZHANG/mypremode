...
\renewcommand{\CancelColor}{\color{goldenrod}}

\makeatletter
\newcommand{\mybox}[1]{%
  \setbox0=\hbox{#1}%
  \setlength{\@tempdima}{\dimexpr\wd0+13pt}%
  \begin{tcolorbox}[colback=goldenrod,colframe=goldenrod,boxrule=0.5pt,arc=4pt,
...
\newcommand{\boxgolden}[1]{
\begin{center}
\fcolorbox{goldenrod}{gray!80!black}{
\begin{minipage}{0.95\textwidth}
#1
\end{minipage}
}
...
\colorlet{goldenTitleBlockColor}{goldenrod}
\colorlet{goldenBlockColor}{goldenrod!25!gray}
...
\AtBeginEnvironment{block}{%
  \setbeamercolor{itemize item}{fg=goldenTitleBlockColor!70}}
