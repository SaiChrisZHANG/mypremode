\section{Estimation}
 ...
 \frame{\sectionpage}
    ...
    \begin{frame}{Weighted Treatment Effects: Example 1}
        $$
        ...
        \uncover<2->{
            \begin{itemize}
                \item<2> RD paramater:
                $$
                \tau_{c}=\mathbb{E}\left[ Y_{i}\left(1\right)-Y_{i}\left(0\right)\mid Z_{i}=c\right] = \int\frac{p\left(c\mid u\right)}{\int p\left(c\mid u\right)\mathrm{d}G\left(u\right)} \tau\left(u\right) \mathrm{d}G\left(u\right)
                $$
            \end{itemize}
        }
